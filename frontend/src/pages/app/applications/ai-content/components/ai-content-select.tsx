      ...
      <DialogContent className="flex flex-col gap-5 pb-7">
        <TabContext value={tabValue}>
          <Box className="flex flex-row justify-between pt-0.25">
            ...
            >
              <Tab
                icon={<NiArrowOutUp size="medium" className="mr-0 md:mr-1" />}
                iconPosition="start"
                label={<Box className="hidden md:flex">Uploads</Box>}
                value="uploads"
              />
              <Tab
                icon={<NiMagicWand size="medium" className="mr-0 md:mr-1" />}
                iconPosition="start"
                label={<Box className="hidden md:flex">Generated</Box>}
                value="generated"
              />
              <Tab
                icon={<NiFloppyDisk size="medium" className="mr-0 md:mr-1" />}
                iconPosition="start"
