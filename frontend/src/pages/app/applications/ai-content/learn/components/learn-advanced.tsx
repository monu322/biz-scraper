        ...
        <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
          <Card className="relative">
            ...
            <Chip
              ...
              size="small"
              variant="outlined"
              className="outline-primary text-primary pointer-events-none absolute top-6 right-6"
            />
          </Card>
        </Grid>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
          <Card className="relative">
            ...
            <Chip
              ...
              size="small"
              variant="outlined"
              className="outline-secondary text-secondary pointer-events-none absolute top-6 right-6"
            />
          </Card>
        </Grid>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
          <Card className="relative">
            ...
            <Chip
              ...
              size="small"
              variant="outlined"
              className="outline-accent-1 text-accent-1 pointer-events-none absolute top-6 right-6"
            />
          </Card>
        </Grid>
