      ...
      <CardContent className="flex flex-col items-center p-7!">
        ...
        <Grid size={12} container spacing={2.5}>
          <Grid size={{ lg: 3, xs: 12, sm: 6 }}>
            ...
            >
              <Box className="bg-primary-light/10 flex h-[4.5rem] w-16 flex-none items-center justify-center rounded-2xl">
          ...
          <Grid size={{ lg: 3, xs: 12, sm: 6 }}>
            <Link
              ...
              className="border-grey-50 flex min-w-48 flex-row items-center rounded-3xl border p-1 transition-transform hover:scale-[1.02]"
            >
              <Box className="bg-secondary-light/10 flex h-[4.5rem] w-16 flex-none items-center justify-center rounded-2xl">
          ...
          <Grid size={{ lg: 3, xs: 12, sm: 6 }}>
            <Link
              ...
              className="border-grey-50 flex min-w-48 flex-row items-center rounded-3xl border p-1 transition-transform hover:scale-[1.02]"
            >
              <Box className="bg-accent-1-light/10 flex h-[4.5rem] w-16 flex-none items-center justify-center rounded-2xl">
          ...
          <Grid size={{ lg: 3, xs: 12, sm: 6 }}>
            <Link
              ...
              className="border-grey-50 flex min-w-48 flex-row items-center rounded-3xl border p-1 transition-transform hover:scale-[1.02]"
            >
              <Box className="bg-accent-2-light/10 flex h-[4.5rem] w-16 flex-none items-center justify-center rounded-2xl">
